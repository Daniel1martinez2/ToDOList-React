...
const Task = props => {
  ...
  return(
    <div className={classes.task}>
      ...
      <button className={classes['task__check']}>
        <svg className="bi bi-check-square" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"  viewBox="0 0 16 16">
